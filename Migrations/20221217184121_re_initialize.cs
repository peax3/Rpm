...
{
    public partial class re_initialize : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    swappable = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_category_prices_categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_user_likes_profiles_ProfileId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    ExchangePoints = table.Column<int>(type: "int", nullable: false),
                    ExchangeProductId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OwnerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OrderStatus = table.Column<int>(type: "int", nullable: false),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Accepted_on = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Dispatched_on = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Received_on = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Dispatcher_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_whish_lists", x => x.Id);
                    table.ForeignKey(
                        name: "FK_whish_lists_products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_category_prices_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_user_likes_ProfileId1",
                table: "user_likes",
                column: "ProfileId1");

            migrationBuilder.CreateIndex(
                name: "IX_whish_lists_ProductId",
                table: "whish_lists",
                column: "ProductId");
        }
