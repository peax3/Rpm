    ...
    <>
       <div className="kalles-section nt_section type_featured_collection tp_se_cdt">
            <div className="kalles-jewelry__tabs-section container">
                {showTitle && <div className="wrap_title des_title_2">
                ...
                <div id="gvXA" className="products nt_products_holder row fl_center row_pr_1 tc cdt_des_5 round_cd_true nt_cover ratio_nt position_8 space_30">
